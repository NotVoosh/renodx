  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = r2.xyz;
  r3.w = 1;
  r4.x = dot(cb0[4].xyzw, r3.xyzw);
  r4.y = dot(cb0[6].xyzw, r3.xyzw);
  r4.z = dot(cb0[7].xyzw, r3.xyzw);
  r4.w = dot(cb0[8].xyzw, r3.xyzw);
  r2.x = dot(r4.xyzw, r1.xyzw);
  r4.x = dot(cb0[9].xyzw, r3.xyzw);
  r4.y = dot(cb0[10].xyzw, r3.xyzw);
  r4.z = dot(cb0[11].xyzw, r3.xyzw);
  r4.w = dot(cb0[12].xyzw, r3.xyzw);
  r2.y = dot(r4.xyzw, r1.xyzw);
  r4.x = dot(cb0[13].xyzw, r3.xyzw);
  r4.y = dot(cb0[14].xyzw, r3.xyzw);
  r4.z = dot(cb0[15].xyzw, r3.xyzw);
  r4.w = dot(cb0[16].xyzw, r3.xyzw);
