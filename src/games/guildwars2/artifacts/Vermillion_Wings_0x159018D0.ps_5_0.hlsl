  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = cb0[10].yx * cb0[1].xx;
  r0.xy = frac(r0.xy);
  r0.x = r0.x * 2 + -1;
  r0.z = cb0[10].w + -cb0[10].z;
  r0.x = abs(r0.x) * r0.z + cb0[10].z;
  r1.z = v0.y * r0.x + r0.y;
  r1.x = v0.x * r0.x;
  r0.xy = t2.Sample(s2_s, r1.xz).xy;
  r0.xy = r0.xy * float2(2,2) + float2(-1,-1);
  r0.zw = cb0[11].yx * cb0[1].xx;
  r0.zw = frac(r0.zw);
  r0.z = r0.z * 2 + -1;
  r1.x = cb0[11].w + -cb0[11].z;
  r0.z = abs(r0.z) * r1.x + cb0[11].z;
  r1.z = v0.y * r0.z + r0.w;
  r1.x = v0.x * r0.z;
  r0.zw = t3.Sample(s3_s, r1.xz).xy;
  r0.xy = r0.zw * float2(2,2) + r0.xy;
  r0.xy = float2(-1,-1) + r0.xy;
  r0.zw = cb0[12].xx * r0.xy;
  r1.xy = cb0[8].yx * cb0[1].xx;
  r1.xy = frac(r1.xy);
  r1.x = r1.x * 2 + -1;
  r1.z = cb0[8].w + -cb0[8].z;
  r1.x = abs(r1.x) * r1.z + cb0[8].z;
  r2.z = v0.y * r1.x + r1.y;
  r2.x = v0.x * r1.x;
  r1.x = cb0[9].x * cb0[1].x + -0.5;
  r1.x = frac(r1.x);
  r1.yz = r0.zw * r1.xx + r2.xz;
  r1.y = t1.Sample(s1_s, r1.yz).y;
  r1.z = cb0[9].x * cb0[1].x;
  r1.z = frac(r1.z);
  ...
  r2.xyz = r0.zzz * r2.xyz + cb0[6].xyz;
  ...
  r2.w = 1;
  r4.x = dot(cb0[5].xyzw, r2.xyzw);
  r4.y = dot(cb0[13].xyzw, r2.xyzw);
  r4.z = dot(cb0[14].xyzw, r2.xyzw);
  r4.w = dot(cb0[15].xyzw, r2.xyzw);
  r4.x = dot(r4.xyzw, r3.xyzw);
  r5.x = dot(cb0[16].xyzw, r2.xyzw);
  r5.y = dot(cb0[17].xyzw, r2.xyzw);
  r5.z = dot(cb0[18].xyzw, r2.xyzw);
  r5.w = dot(cb0[19].xyzw, r2.xyzw);
  r4.y = dot(r5.xyzw, r3.xyzw);
  r5.x = dot(cb0[20].xyzw, r2.xyzw);
  r5.y = dot(cb0[21].xyzw, r2.xyzw);
  r5.z = dot(cb0[22].xyzw, r2.xyzw);
  r5.w = dot(cb0[23].xyzw, r2.xyzw);
  ...
  r3.xyz = cb0[24].xxx * r2.xyz;
  r2.xyzw = cb0[25].xxxx * r3.xyzw;
  r0.z = t4.Sample(s4_s, v1.xy).x;
  r0.w = cb0[26].y + -cb0[26].x;
  r0.z = r0.z * r0.w + cb0[26].x;
  r0.xy = r0.xy * r0.zz;
