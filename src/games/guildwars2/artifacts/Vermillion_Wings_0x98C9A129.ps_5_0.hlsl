  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xyz = r1.xyz;
  r2.w = 1;
  r1.x = dot(r2.xyzw, cb0[4].xyzw);
  r1.y = dot(r2.xyzw, cb0[5].xyzw);
  r1.z = dot(r2.xyzw, cb0[6].xyzw);
  r0.yzw = -r0.xxx * v1.xyz + r1.xyz;
  r0.x = 4 * r0.x;
  r0.x = min(1, r0.x);
  r3.xyzw = t0.Sample(s0_s, v0.xy).xyzw;
  r0.yzw = r3.xxx * r0.yzw + r2.xyz;
  r1.x = dot(r2.xyzw, cb0[7].xyzw);
  r1.y = dot(r2.xyzw, cb0[8].xyzw);
  r1.z = dot(r2.xyzw, cb0[9].xyzw);
  r1.xyz = r1.xyz + -r0.yzw;
  r2.xyz = r3.yyy * r1.xyz + r0.yzw;
  r2.w = 1;
  r1.x = dot(r2.xyzw, cb0[10].xyzw);
  r1.y = dot(r2.xyzw, cb0[11].xyzw);
  r1.z = dot(r2.xyzw, cb0[12].xyzw);
  r0.yzw = r1.xyz + -r2.xyz;
  r0.yzw = r3.zzz * r0.yzw + r2.xyz;
  r1.x = dot(r2.xyzw, cb0[13].xyzw);
  r1.y = dot(r2.xyzw, cb0[14].xyzw);
  r1.z = dot(r2.xyzw, cb0[15].xyzw);
  r1.xyz = r1.xyz + -r0.yzw;
