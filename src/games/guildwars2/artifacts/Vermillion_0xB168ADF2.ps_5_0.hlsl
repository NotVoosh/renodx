  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.x = 28 * r2.w;
  r1.yzw = cb0[6].xyz * r3.xyz + r1.yzw;
  r1.yzw = r1.yzw * r3.xyz;
  r1.yzw = v3.xyz * r1.yzw;
  r4.xyz = saturate(r1.yzw + r1.yzw);
  r4.w = 1;
  r5.x = dot(cb0[5].xyzw, r4.xyzw);
  r5.y = dot(cb0[14].xyzw, r4.xyzw);
  r5.z = dot(cb0[15].xyzw, r4.xyzw);
  r5.w = dot(cb0[16].xyzw, r4.xyzw);
  r5.x = dot(r5.xyzw, r0.xyzw);
  r6.x = dot(cb0[17].xyzw, r4.xyzw);
  r6.y = dot(cb0[18].xyzw, r4.xyzw);
  r6.z = dot(cb0[19].xyzw, r4.xyzw);
  r6.w = dot(cb0[20].xyzw, r4.xyzw);
  r5.y = dot(r6.xyzw, r0.xyzw);
  r6.x = dot(cb0[21].xyzw, r4.xyzw);
  r6.y = dot(cb0[22].xyzw, r4.xyzw);
  r6.z = dot(cb0[23].xyzw, r4.xyzw);
  r6.w = dot(cb0[24].xyzw, r4.xyzw);
  r5.z = dot(r6.xyzw, r0.xyzw);
  r0.xyz = -r5.xyz + r4.xyz;
  r0.xyz = r1.xxx * r0.xyz + r5.xyz;
  r3.xyz = r0.xyz * r3.www;
  r0.xyz = r3.xyz;
  r1.x = dot(r3.ww, cb0[25].xx);
  r0.w = 0;
