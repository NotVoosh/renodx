  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = dot(r0.xyz, float3(1.0 / 3.0, 1.0 / 3.0, 1.0 / 3.0));
  r2.xyz = r0.xyz / r1.www;
  r2.xyz = -cb0[5].xyz + r2.xyz;
  r1.w = dot(abs(r2.xyz), float3(1.0 / 3.0, 1.0 / 3.0, 1.0 / 3.0));
  r1.w = min(1, r1.w);
  r1.w = 1 + -r1.w;
  r1.w = r1.w * 0.999989986 + 9.99999975e-06;
  r1.w = pow(r1.w, cb0[5].w);
  r1.w = cb0[6].w * r1.w * injectedData.colorGradeTint;
  r2.x = renodx::color::y::from::BT709(r0.xyz);
  r0.xyz = lerp(r0.xyz, cb0[6].xyz * r2.xxx, r1.w);
  ...
  r0.w = r0.w * 2 + -1;
  if (r0.w < -0.01) {
    r1.yzw = lerp(1.f, cb0[4].xyz, injectedData.fxSelectionOutline) * r0.xyz;
  } else {
    if (r0.w > 0.01) {
      r1.yzw = lerp(1.f, cb0[2].xyz, injectedData.fxSelectionOutline) * r0.xyz;
    } else {
      r0.w = 1.2 * cb0[7].z;
      r2.z = cb0[7].x * r0.w;
