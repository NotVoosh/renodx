...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x5A5ED44A),  // SSRT
    CustomShaderEntry(0x23448FC5),  // uberpost
    CustomShaderEntry(0x8CBAADE3),  // uberpost
    CustomShaderEntry(0x937ECFDB),  // uberpost
    CustomShaderEntry(0xCC530EBB),  // uberpost
    CustomShaderEntry(0x366EE13E),  // final pp
    CustomShaderEntry(0xCC8B6ACF),  // final pp (fxaa)
    CustomShaderEntry(0x20133A8B),  // Final (swapchain)
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for The Precinct";
