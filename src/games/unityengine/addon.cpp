...
const ShaderItem INITIAL_SHADERS[] = {
    ...
    CustomShaderEntryCallback(0xE6B97032, &UberHDRP),
    ...
    CustomShaderEntryCallback(0x06779954, &UberLinear),
    CustomShaderEntryCallback(0x5D7DCAA9, &UberLinear),
    CustomShaderEntryCallback(0xB6CB924F, &UberLinear),
    CustomShaderEntryCallback(0x1B985159, &UberLinear),
    CustomShaderEntryCallback(0x3503DCAE, &UberLinear),
    ...
    CustomShaderEntryCallback(0x31CF94AC, &UberGamma),
    CustomShaderEntryCallback(0xD9D3B706, &UberGamma),
    CustomShaderEntryCallback(0x1F260B38, &UberGamma),
    CustomShaderEntryCallback(0x23D6369B, &UberGamma),
    CustomShaderEntryCallback(0x96DF466B, &UberGamma),
    ...
    CustomShaderEntryCallback(0xFA5BE462, &UberACESLinear),
    ...
    CustomShaderEntryCallback(0x342E56C7, &UberHDLinear),
    ////// URP END //////
    ////// CUSTOM START //////
    ...
    CustomShaderEntryCallback(0xEE465E2D, &CountTonemap1),
      // Bloom
    ...
    CustomShaderEntryCallback(0xFFC39101, &Clamped),               // Noise and Grain
    ...
    CustomShaderEntryCallback(0x1DE983F0, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x599066C8, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0xDDC88868, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x0616D26C, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x6F0C66BA, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x1B172164, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x2339A919, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x662E01AB, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x9F02B611, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0xBB36315A, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0xF3FC5F05, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x9B2BBC4D, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0xBBF7CCB9, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x84868CA0, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x54DC05DE, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0xAE488FB0, &CountGammaTonemap1Clamped), // user LUT
    CustomShaderEntryCallback(0x7FA6CC54, &CountGammaTonemap1Clamped),
      /// PP
        // SRGB internal LUT
    ...
    CustomShaderEntryCallback(0x9C2BCF45, &UberGamma),
    ...
    CustomShaderEntryCallback(0x42383A0E, &UberGamma),
    ...
    CustomShaderEntryCallback(0x03AB4108, &UberHDLinear),
    ...
    CustomShaderEntryCallback(0xC05FCCFB, &UberHDLinear),
    ...
    CustomShaderEntryCallback(0x691CF2FB, &UberHDLinear),
    ...
    CustomShaderEntryCallback(0xEB594928, &UberHDLinear),
    CustomShaderEntryCallback(0x9C62C0D7, &UberHDLinear),
    CustomShaderEntryCallback(0x123EB0AB, &UberHDLinear),
    CustomShaderEntryCallback(0x5032F099, &UberHDLinear),
    CustomShaderEntryCallback(0x7910DC27, &UberHDLinear),
    CustomShaderEntryCallback(0x8B00D455, &UberHDLinear),
    CustomShaderEntryCallback(0x7C7A90FB, &UberHDLinear),
    CustomShaderEntryCallback(0xABD0CDAB, &UberHDLinear),
    CustomShaderEntryCallback(0x9861B876, &UberHDLinear),
    CustomShaderEntryCallback(0x085B95F5, &UberHDLinear),
    CustomShaderEntryCallback(0xC59328DA, &UberHDLinear),
    CustomShaderEntryCallback(0xB94F0EC5, &UberHDLinear),
    CustomShaderEntryCallback(0xC13DFB36, &UberHDLinear),
    CustomShaderEntryCallback(0x609D706C, &UberHDLinear),
    CustomShaderEntryCallback(0xB05DD1FC, &UberHDLinear),
    ...
    CustomShaderEntryCallback(0x7209AC65, &UberHDGamma),
    CustomShaderEntryCallback(0xA932CAC7, &UberHDGamma),
    CustomShaderEntryCallback(0x30B1D393, &UberHDGamma),
    CustomShaderEntryCallback(0x80309D55, &UberHDGamma),
    ...
    CustomShaderEntryCallback(0x5C428D81, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x6DD82EF0, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x9DA6D2DA, &CountLinearTonemap1),
    ...
    CustomShaderEntryCallback(0x83B430B4, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x92C3775F, &CountLinearTonemap1),
    // 0x2365EDDF
    CustomShaderEntryCallback(0x4757CDEB, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x6946B0AB, &CountGammaTonemap1),
    CustomShaderEntryCallback(0x93281DC0, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x455563C6, &CountLinearTonemap1),
    CustomShaderEntryCallback(0x79295705, &CountGammaTonemap1),
    // 0xA1EA3B3E
    CustomShaderEntryCallback(0xA8773EA9, &CountLinearTonemap1),
    ...
    CustomShaderEntryCallback(0x34A4537A, &CountGammaTonemap1),
        // Sapphire (Windbound)
    CustomShaderEntryCallback(0x2B0930CC, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x8D4D9A63, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x8DF1BF80, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x14A5B821, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x15E132D9, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x171A0A90, &CountLinearTonemap35),
    CustomShaderEntryCallback(0x85653627, &CountLinearTonemap35),
    CustomShaderEntryCallback(0xAE663C8F, &CountLinearTonemap35),
    CustomShaderEntryCallback(0xBA4DCC6E, &CountLinearTonemap35),
    CustomShaderEntryCallback(0xE01E2588, &CountLinearTonemap35),
        // Neutral
