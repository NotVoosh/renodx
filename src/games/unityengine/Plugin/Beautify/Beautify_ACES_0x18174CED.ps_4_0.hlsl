  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[21].z < cb0[2].z) {
    r4.xyzw = t3.SampleLevel(s5_s, w1.xy, 0).xyzw;
    r2.x = dot(r4.xyzw, float4(1,0.00392156886,1.53787005e-05,6.03086292e-08));
    r4.xyzw = t4.SampleLevel(s6_s, w1.xy, 0).xyzw;
    r2.z = dot(r4.xyzw, float4(1,0.00392156886,1.53787005e-05,6.03086292e-08));
    r4.xyzw = t1.SampleLevel(s1_s, v2.xy, v2.w).xyzw;
    r2.w = cb1[7].x * r4.x + cb1[7].y;
    r2.w = 1 / r2.w;
    r2.x = min(r2.w, r2.x);
    float value = r2.x;
    r2.w = cb1[5].z * r2.x;
    r2.x = r2.x * cb1[5].z + -cb0[17].x;
    /*r4.x = cmp(r2.w < cb0[17].x);
    r4.x = r4.x ? 1.000000 : 0;*/
    r4.x = step(r2.w, cb0[17].x);
    r2.x = -cb0[18].x * r4.x + abs(r2.x);
    r2.x = cb0[17].y * r2.x;
    r2.x = 0.5 * r2.x;
    r2.x = r2.x / r2.w;
    r2.x = r2.z >= value ? r2.x : 0;
  ...
  r1.xyzw = t6.Sample(s3_s, float2(0.5,0.5)).xyzw;
