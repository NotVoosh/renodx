  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.yzw = renodx::color::pq::Decode(r1.yzw);
  r1.yzw = renodx::color::bt709::from::BT2020(r1.yzw);
  r1.yzw = renodx::math::SignSqrt(r1.yzw);
  }
  ...
  r2.xyz = renodx::color::pq::Decode(r2.xyz);
  r2.xyz = renodx::color::bt709::from::BT2020(r2.xyz);
  ...
  r4.xyz = renodx::color::pq::Decode(r4.xyz);
  r4.xyz = renodx::color::bt709::from::BT2020(r4.xyz);
  r4.xyz = renodx::math::SignSqrt(r4.xyz);
  }
  r0.w = dot(r4.xyz, float3(0.298999995,0.587000012,0.114));
  r1.y = min(r1.y, r0.w);
  r0.z = max(r0.z, r0.w);
  r4.xy = r0.xy * cb0[2].xy + r3.zw;
  r4.z = 0;
  ...
  if (injectedData.toneMapType != 0.f && injectedData.FSRcheck != 0.f) {
    o0.xyz = renodx::math::SignPow(o0.xyz, 2.f);
    o0.xyz = renodx::color::bt2020::from::BT709(o0.xyz);
    o0.xyz = renodx::color::pq::EncodeSafe(o0.xyz);
    o0.xyz = sqrt(o0.xyz);
  }
  o0.w = 1;
  return;
