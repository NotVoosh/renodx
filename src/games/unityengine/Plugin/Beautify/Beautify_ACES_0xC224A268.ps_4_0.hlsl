  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = cb0[7].x * r0.z;
  r0.y = cb0[7].w / abs(r0.y);
  //r1.x = cmp(1 < r0.y);
  r1.x = step(1, r0.y);
  r0.y = saturate(cb0[14].x * r0.y);
  ...
  r1.xyz = r1.xyz * cb0[5].www + float3(1,1,1);
  ...
  r2.xyz = cb0[12].xxx * r2.xyz * injectedData.fxBloom;
  ...
  r1.y = renodx::color::y::from::NTSC1953(r0.xyw);
  r2.xy = cb0[20].xx * float2(1.14,2.99) + float2(1,1);
  r1.x = r1.y / r2.x;
  r1.z = r2.y * r1.y;
  r1.xzw = saturate(r1.xyz);
  r0.xyw = -r1.xzw + r0.xyw;
  r2.xyzw = t3.Sample(s3_s, float2(0.5,0.5)).xyzw;
  r2.x = 1.44269502 * r2.y;
  r2.x = exp2(r2.x);
  r2.x = saturate(-cb0[20].y + r2.x);
  r0.xyw = r2.xxx * r0.xyw + r1.xzw;
  r1.xyz = r1.yyy * cb0[15].xyz + -r0.xyw;
  r2.xy = float2(-0.5,-0.5) + w1.xy;
  r2.z = cb0[16].x * r2.x;
  r1.w = dot(r2.yz, r2.yz);
  r1.w = saturate(cb0[15].w * r1.w + cb0[20].z);
