  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = r2.xyz * r0.xyz + float3(-9.05370034e-05,-9.05370034e-05,-9.05370034e-05);
  r1.xyw = r2.xyz * float3(0.983729005,0.983729005,0.983729005) + float3(0.432951003,0.432951003,0.432951003);
  r1.xyw = r2.xyz * r1.xyw + float3(0.238080993,0.238080993,0.238080993);
  r0.xyz = r0.xyz / r1.xyw;
  r2.x = dot(float3(1.60475004,-0.531080008,-0.0736699998), r0.xyz);
  r2.y = dot(float3(-0.102080002,1.10812998,-0.00604999997), r0.xyz);
  r2.z = dot(float3(-0.00326999999,-0.0727600008,1.07602), r0.xyz);*/
