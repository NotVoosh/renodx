  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.z == 0.0 || r1.z >= 0.15) {
    ...
    r3.x = dot(r2.xyz, float3(0.222,0.707,0.071));
    r3.y = 1;
    r2.xyzw = -r3.xxxy + r2.xyzw;
    r2.xyzw = cb0[4].zzzz * r2.xyzw + r3.xxxy;  // saturation
    /*r1.y = 1 + cb0[4].w;
    ...
    if (cb0[5].z < 1) {
      ...
      r2.x = dot(r1.xyz, float3(0.222,0.707,0.071));
      r2.y = 1;
      r1.xyzw = -r2.xxxy + r1.xyzw;
      r1.xyzw = cb0[4].zzzz * r1.xyzw + r2.xxxy;  // saturation
      /*r2.x = 1 + cb0[4].w;
