  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (injectedData.colorGradeUserLUTStrength == 0.f || config.type == 1.f) {
    ...
    float grayscale = renodx::color::y::from::BT709(r0.xyz.rgb);
    float3 gamma_color = renodx::color::gamma::EncodeSafe(r0.xyz.rgb);
    float encoded_gray = renodx::color::gamma::Encode(grayscale);
  ...
  r0.xyz = renodx::color::gamma::DecodeSafe(gamma_color);
  r0.w = 0.5;
