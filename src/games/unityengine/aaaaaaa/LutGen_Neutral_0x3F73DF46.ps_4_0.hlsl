  ...
  out float4 o0 : SV_Target0)
{
  ...
  o0.y = saturate(r1.y);
    ...
    if (config.type == 0.f) {
      ...
      r0.xyz = renodx::tonemap::UpgradeToneMap(hdrColor, sdrColor, o0.xyz, injectedData.colorGradeInternalLUTStrength);
    }
  }
  r0.xyz = grading(r0.xyz);
  o0.xyz = r0.xyz;
  /*r0.xyz = max(float3(0,0,0), r0.xyz);
  r0.w = cb0[15].z * cb0[15].y;
  r1.x = cb0[15].x * cb0[16].z + r0.w;
  r1.yz = cb0[16].xy * cb0[15].ww;
  r1.x = cb0[16].z * r1.x + r1.y;
  r1.w = cb0[15].x * cb0[16].z + cb0[15].y;
  r1.w = cb0[16].z * r1.w + r1.z;
  r1.x = r1.x / r1.w;
  r1.w = cb0[16].x / cb0[16].y;
  r1.x = r1.x + -r1.w;
  r1.x = 1 / r1.x;
  r0.xyz = r1.xxx * r0.xyz;
  r2.xyz = cb0[15].xxx * r0.xyz + r0.www;
  r2.xyz = r0.xyz * r2.xyz + r1.yyy;
  r3.xyz = cb0[15].xxx * r0.xyz + cb0[15].yyy;
  r0.xyz = r0.xyz * r3.xyz + r1.zzz;
  r0.xyz = r2.xyz / r0.xyz;
  r0.xyz = r0.xyz + -r1.www;
  r0.xyz = r0.xyz * r1.xxx;
  r0.xyz = r0.xyz / cb0[16].www;
