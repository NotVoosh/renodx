  ...
  out float4 o0 : SV_Target0)
{
  ...
  float3 hdrColor = renodx::color::srgb::DecodeSafe(r2.xyz);
  float3 sdrColor = lerp(hdrColor, renodx::tonemap::renodrt::NeutralSDR(hdrColor), saturate(renodx::tonemap::renodrt::NeutralSDR(hdrColor)));
  float3 userLutInput = injectedData.toneMapType <= 1.f ? hdrColor : sdrColor;
  ...
  if (injectedData.toneMapType != 0.f) {
    ...
    r0.xyz = renodx::tonemap::UpgradeToneMap(hdrColor, sdrColor, r0.xyz, injectedData.colorGradeUserLUTStrength);
  }
  float3 preCG = r0.xyz;
  ...
  r3.xyz = cb0[29].www * r3.xyz + r0.xyz;
  ...
  r2.xyz = r2.xyz + -r0.xyz;
  r0.xyz = cb0[28].www * r2.xyz + r0.xyz;
  r2.xyz = r3.xyz + -r0.xyz;
  r0.xyz = cb0[30].xxx * r2.xyz + r0.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  r0.xyz = cb0[33].yyy * r1.xyz + r0.xyz;
