  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.yz = step(cb0[13].xy, r2.yz);
  /*r3.xy = cmp(cb0[13].zw >= r2.yz);
  r3.xy = r3.xy ? float2(1,1) : 0;*/
  r3.xy = step(r2.yz, cb0[13].zw);
  r1.y = r3.x * r1.y;
  r1.y = r1.y * r1.z;
  r1.y = r1.y * r3.y;
  r1.z = r1.y * r0.w;
  ...
  r1.yz = r1.yz ? float2(1,1) : 0;*/
  r1.yz = step(cb0[9].xy, r2.yz);
  /*r3.xy = cmp(cb0[9].zw >= r2.yz);
  r3.xy = r3.xy ? float2(1,1) : 0;*/
  r3.xy = step(r2.yz, cb0[9].zw);
  r1.y = r3.x * r1.y;
  r1.y = r1.y * r1.z;
  r1.y = r1.y * r3.y;
  ...
  r1.zw = step(cb0[11].xy, r2.yz);
  /*r3.xy = cmp(cb0[11].zw >= r2.yz);
  r3.xy = r3.xy ? float2(1,1) : 0;*/
  r3.xy = step(r2.yz, cb0[11].zw);
  r0.w = r3.x * r1.z;
  r0.w = r0.w * r1.w;
  r0.w = r0.w * r3.y;
  ...
  r1.yz = r1.yz ? float2(1,1) : 0;*/
  r1.yz = step(cb0[15].xy, r2.yz);
  /*r2.yw = cmp(cb0[15].zw >= r2.yz);
  r2.yw = r2.yw ? float2(1,1) : 0;*/
  r2.yw = step(r2.yz, cb0[15].zw);
  r1.y = r2.y * r1.y;
  r1.y = r1.y * r1.z;
  r1.y = r1.y * r2.w;
  ...
  r0.w = step(0.001, r1.y);
  /*r1.z = cmp(cb0[16].z >= 0);
  r1.z = r1.z ? 1.000000 : 0;*/
  r1.z = step(0, cb0[16].z);
