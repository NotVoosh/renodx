...
// ---- Created with 3Dmigoto v1.3.16 on Fri Oct  4 05:49:16 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.w = 0.0625 * r0.w;
  r0.xyzw = r4.xyzw * injectedData.fxBloom + r1.xyzw;
  r0.xyzw = r2.xyzw * r3.xyzw * injectedData.fxLensFlare + r0.xyzw;
  ...
  if (r1.x != 0) {
    ...
    r1.x = max(0, r1.x);
    r1.x = log2(r1.x);
    r1.x = cb0[39].y * r1.x * injectedData.fxVignette;
    r1.x = exp2(r1.x);
  ...
  r1.xyzw = t5.Sample(s5_s, r0.xyz).xyzw;                       // log LUT
    
    float vanillaGray = renodx::color::y::from::BT709(r1.rgb);
    r1.rgb = applyUserTonemap(untonemapped, t5, s5_s, vanillaGray);
