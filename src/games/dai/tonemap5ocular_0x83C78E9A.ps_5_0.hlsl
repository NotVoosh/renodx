// used when looking through an Ocularum long view thingie, special post-processing, switches with tonemap6

#include "./shared.h"
#include "./tonemapper.hlsl"																			// custom tonemapper

// ---- Created with 3Dmigoto v1.3.16 on Wed Jul 31 01:58:51 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = r0.xyz * float3(6.19999981,6.19999981,6.19999981) + float3(0.5,0.5,0.5);							// OG tonemapper
  ...
  o0.xyz = r0.xyz;																							// vanilla output
	...
	o0.rgb = applyUserTonemap(untonemapped.rgb, colorGradingTexture, colorGradingTextureSampler_s, LUTless.rgb, vanilla.rgb);
  return;
}