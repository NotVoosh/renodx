// The Hinterlands skybox with massive sun

#include "./shared.h"

// ---- Created with 3Dmigoto v1.3.16 on Wed Jul 31 01:55:43 2024
  ...
  out float o1 : SV_Target1)
{
  ...
  //r0.z = 1 + -g_sunColorAndSize.w;												// smaller
  ...
  r0.z = r2.w / r0.z;
  r0.z = min(1, r0.z);
  //r6.xyz = g_sunColorAndSize.xyz * r0.zzz;											// but not too much
  ...
  r3.w = 0;
  while (true) {
    r4.w = cmp((int)r3.w >= (int)r3.x);
    if (r4.w != 0) break;
    r9.z = g_depthTexture.Load(r1.xy, r3.w).x;
    r4.w = cmp(r9.z == 1.000000);
    r5.w = r4.w ? 0 : 1;
    r6.w = r4.w ? -r0.x : -1;
    r2.z = r6.w + r2.z;
    ...
    r0.z = r3.z * r4.w + r0.z;
    r0.y = r5.w + r0.y;
    r13.x = dot(r9.xyzw, g_invViewProjMatrix._m00_m10_m20_m30);
    r13.y = dot(r9.xyzw, g_invViewProjMatrix._m01_m11_m21_m31);
    r13.z = dot(r9.xyzw, g_invViewProjMatrix._m02_m12_m22_m32);
    r4.w = dot(r9.xyzw, g_invViewProjMatrix._m03_m13_m23_m33);
    r13.xyz = r13.xyz / r4.www;
    r13.xyz = g_camPos.xyz + -r13.xyz;
    r4.w = dot(r13.xyz, r13.xyz);
    r4.w = sqrt(r4.w);
    r10.z = saturate(r4.w * r2.w + g_fogParams.x);
    r10.y = r10.z * r10.z;
    r10.x = r10.z * r10.y;
    r4.w = saturate(dot(r10.xyzw, g_fogCoefficients.xyzw));
    r10.xyz = r7.xyz * r4.www;
    r13.xyz = r10.xyz * r5.www;
    r13.w = r4.w * r5.w;
    r11.xyzw = r13.xyzw + r11.xyzw;
    r12.xyz = r8.xyz * r4.www + r12.xyz;
    r3.w = (int)r3.w + 1;
  }
  r0.x = cmp(1 < r0.y);
  if (r0.x != 0) {
  ...
  r2.w = 1;
  r2.xyzw = r2.xyzw + -r11.xyzw;
  r0.xyzw = r0.zzzz * r2.xyzw + r11.xyzw;
  r1.w = 0;
