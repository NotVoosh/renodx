// used in cutscenes, specifically at the end/fade to black? Different from the others, Gamma 2.2 why ???
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = log2(r0.xyz);
  r0.xyz = float3(0.454545468,0.454545468,0.454545468) * r0.xyz;											// WHY? BIOWARE PLS EXPLAIN 
  r0.xyz = exp2(r0.xyz);
