// The Hinterlands (SE) skybox with massive sun

#include "./shared.h"

// ---- Created with 3Dmigoto v1.3.16 on Wed Jul 31 02:03:10 2024
  ...
  out float o1 : SV_Target1)
{
  ...
  r0.x = sqrt(r0.x);
  r0.y = g_fogParams.z / r4.w;
  r1.z = saturate(r0.x * r0.y + g_fogParams.x);
  r1.y = r1.z * r1.z;
  r1.x = r1.z * r1.y;
  r1.w = 1;
  r0.x = saturate(dot(r1.xyzw, g_fogCoefficients.xyzw));
  r0.y = g_forwardScatteringParams.x * r2.z + 1;
  r0.y = r0.y * r0.y;
  r0.y = g_forwardScatteringParams.y / r0.y;
  r1.xyz = g_forwardScatteringColorPresence.xyz * r0.yyy;
