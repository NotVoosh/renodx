...
// ---- Created with 3Dmigoto v1.3.16 on Wed Jul 31 01:58:10 2024
...
// unknown dcl_: dcl_resource_texture1d (float,float,float,float) t1
  ...
  r0.x = 1 / mainTextureDimensions.x;
  r0.y = -r0.x * 0.5 + v1.x;
  r0.z = mainTextureDimensions.x * r0.y;
  r0.z = frac(r0.z);
  r0.w = -0.5 + -r0.z;
  ...
  r2.yzw = mainTexture.Sample(mainTextureSampler_s, r2.xy).xyz;
  r3.x = dot(r1.xyzw, float4(1,1,1,1));
  r1.xyzw = r1.xyzw / r3.xxxx;
  r0.yzw = r1.yyy * r0.yzw;
  r0.yzw = r1.xxx * r2.yzw + r0.yzw;
  r3.x = r0.x * 2 + r2.x;
  r3.z = r0.x * 3 + r2.x;
  r3.yw = v1.yy;
