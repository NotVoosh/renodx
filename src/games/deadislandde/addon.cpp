...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntryCallback(0x558540C8, [](reshade::api::command_list* cmd_list) {    // gamma
    stateCheck = true;
    return true;
    }),
...
void OnPresent(
    ...
    shader_injection.stateCheck = stateCheck;
    stateCheck = false;
}
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Dead Island (& Riptide) Definitive Edition";
