  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = saturate(dot(r0.xyz, cb0[6].xyz));
  r1.xyz = cb0[8].xyz * r0.www;
  r2.xyz = r0.xyz * cb0[9].xyz + -r1.xyz;
  r0.w = saturate(dot(r0.xyz, cb0[7].xyz));
  r1.xyz = r0.www * r2.xyz + r1.xyz;
  if (injectedData.toneMapType == 0.f) {
    r1.xyz = saturate(r1.xyz);
  }
  r0.xyz = r0.xyz * cb0[8].www + r1.xyz;
  ...
  r0.xyz = saturate(r0.xyz * cb0[10].xyz + cb0[11].xyz);
  r0.xyz = log2(r0.xyz);
  r0.xyz = cb0[14].xyz * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.xyz = saturate(r0.xyz * cb0[12].xyz + cb0[13].xyz);
  ...
  r0.xyz = cb0[3].yyy * r1.xyz + r0.xyz;
  if (config.type == 0.f) {
    r0.xyz = saturate(r0.xyz);
  } else {
