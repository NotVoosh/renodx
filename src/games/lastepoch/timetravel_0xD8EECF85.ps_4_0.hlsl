...
// ---- Created with 3Dmigoto v1.3.16 on Tue Oct  1 06:11:46 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  //r2.xyzw = saturate(float4(0.223139301,0.728760183,1.63921595,0) * r2.xyzw);
  ...
  //r1.xyzw = saturate(float4(0.330178589,0.321568608,0.58431381,0) * r1.xyzw);
  ...
  //r3.xyzw = saturate(float4(0.137161002,0.175536007,1.63735998,0) * r3.xyzw);
    r3.xyzw = float4(0.137161002, 0.175536007, 1.63735998, 0) * r3.xyzw;
  //r4.xyzw = saturate(float4(0.117773801,0.122330502,1.18393695,0) * r4.xyzw);
