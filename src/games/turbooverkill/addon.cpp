...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x86E67F52),  // uber
    CustomShaderEntry(0x8135A20B),  // uber
    CustomShaderEntry(0x063470DC),  // uber
    CustomShaderEntry(0xA46C1ECB),  // uber
    CustomShaderEntry(0xAF565E99),  // uber
    CustomShaderEntry(0xAFBE175C),  // uber
    CustomShaderEntry(0xD25C43B1),  // uber
    CustomShaderEntry(0xFF4E4EF2),  // uber
    CustomShaderEntry(0x92C3775F),  // uber (no grading)
    CustomShaderEntry(0x4757CDEB),  // uber (no grading)
    CustomShaderEntry(0xA8773EA9),  // uber (no grading)
    CustomShaderEntry(0x366EE13E),  // post final
    CustomShaderEntry(0xB13A3CBB),  // post final
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Turbo Overkill";
