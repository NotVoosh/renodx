  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = t0.Load(r0.xyzw).xyzw;
    ...
    r1.r = renodx::math::SqrtSafe(r1.r);
  r1.x = cb0[0].y * -r1.x + 1;
  ...
  r1.w = 1 + -r1.w;
  r0.w = r1.w * r0.w;
  r0.xyz = renodx::color::bt709::clamp::AP1(r0.www * float3(0.00392156886,0.00392156886,0.00392156886)) * injectedData.fxNoise + r0.xyz;    // dithering
