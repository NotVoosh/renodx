// ---- Created with 3Dmigoto v1.3.16 on Thu Aug 22 01:14:01 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = max(0, r0.y);
  r2.z = sqrt(r0.y);
  r0.yzw = float3(-0.200000003,-0.200000003,-0.200000003) + abs(v6.xyz);
