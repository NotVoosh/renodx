// ---- Created with 3Dmigoto v1.3.16 on Thu Aug 22 01:13:13 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = cb0[8].x * cb0[1].x;
  r1.zw = cb0[9].xx * v0.xy;
  r1.y = r0.x * 2 + r1.z;
  r0.xy = r1.yw + r1.yw;
  r0.xy = t2.Sample(s2_s, r0.xy).xy;
  r0.xy = r0.xy * float2(2,2) + float2(-1,-1);
  r1.x = cb0[8].x * cb0[1].x + r1.z;
  r0.zw = t2.Sample(s2_s, r1.xw).xy;
  r0.xy = r0.zw * float2(2,2) + r0.xy;
  r0.xy = float2(-1,-1) + r0.xy;
  r0.xy = cb0[7].xx * r0.xy + v0.xy;
  r0.zw = float2(0.5,0.5) * r0.xy;
  r1.xyzw = t1.Sample(s1_s, r0.xy).xyzw;
  r2.z = cb0[10].x * r0.w;
  r0.x = cb0[11].x * cb0[1].x;
  r2.x = r0.z * cb0[10].x + r0.x;
  r0.x = r0.z * cb0[12].x + r0.x;
  r0.z = cb0[12].x * r0.w;
  ...
  r2.w = exp2(r1.z);
  r1.y = exp2(r1.y);
  r3.xyz = cb0[6].xyz + -cb0[5].xyz;
  r1.yzw = r1.yyy * r3.xyz + cb0[5].xyz;
  r3.xyz = saturate(r1.yzw * r0.xyz);
  r0.x = dot(r0.ww, cb0[26].xx);
  ...
  r3.w = 1;
  r5.x = dot(cb0[4].xyzw, r3.xyzw);
  r5.y = dot(cb0[14].xyzw, r3.xyzw);
  r5.z = dot(cb0[15].xyzw, r3.xyzw);
  r5.w = dot(cb0[16].xyzw, r3.xyzw);
  r5.x = dot(r5.xyzw, r4.xyzw);
  r6.x = dot(cb0[17].xyzw, r3.xyzw);
  r6.y = dot(cb0[18].xyzw, r3.xyzw);
  r6.z = dot(cb0[19].xyzw, r3.xyzw);
  r6.w = dot(cb0[20].xyzw, r3.xyzw);
  r5.y = dot(r6.xyzw, r4.xyzw);
  r6.x = dot(cb0[21].xyzw, r3.xyzw);
  r6.y = dot(cb0[22].xyzw, r3.xyzw);
  r6.z = dot(cb0[23].xyzw, r3.xyzw);
  r6.w = dot(cb0[24].xyzw, r3.xyzw);
