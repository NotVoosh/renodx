  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = float2(0.00600000005,0.00400000019) / r1.xx;
  r1.z = -r1.y + r0.w;
  r1.w = r1.x + -r1.y;
  ...
  r2.xyzw = float4(0.100000001,0.370000005,0.129999995,0.479999989) * animationTimer;
  r2.x = cos(r2.x);
  r3.yz = r1.xy * r2.xx + r2.yy;
  r3.xw = float2(0.00100000005,0.00100000005) + r3.zz;
  r1.x = r3.x * 0.5 + r3.y;
  r1.y = frac(r1.x);
  r1.x = floor(r1.x);
  r2.x = frac(r3.x);
  ...
  r3.xyz = float3(0.800000012,0.800000012,0.800000012) + -r6.xyz;
  ...
  r2.xw = float2(0.00100000005,0.00100000005) + r2.zz;
  r1.y = r2.x * 0.5 + r2.y;
  r1.z = frac(r1.y);
  r1.y = floor(r1.y);
  r1.w = frac(r2.x);
  ...
  r2.x = -r1.w * 0.200000003 + 1;
  r1.w = max(0.800000012, r1.w);
  r1.w = min(1.20000005, r1.w);
