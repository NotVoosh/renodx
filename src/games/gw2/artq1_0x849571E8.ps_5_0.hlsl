// ---- Created with 3Dmigoto v1.3.16 on Wed Oct 23 19:20:23 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = cb0[6].zw * cb0[1].xx;
  r0.xy = frac(r0.xy);
  r0.xy = cb0[6].xy * v0.xy + r0.xy;
  r0.x = t0.Sample(s0_s, r0.xy).w;
  r0.yz = cb0[7].zw * cb0[1].xx;
  r0.yz = frac(r0.yz);
  r0.yz = v0.xy * cb0[7].xy + r0.yz;
  r0.y = t0.Sample(s0_s, r0.yz).w;
  r0.x = r0.x + r0.y;
  r0.xyzw = cb0[5].xyzw * r0.xxxx;
  r1.xy = cb0[3].xx + v4.xy;
  ...
  r2.xyzw = cb0[10].xyzw + -cb0[9].xyzw;
  r2.xyzw = r1.zzzz * r2.xyzw + cb0[9].xyzw;
  r2.xyzw = r1.yyyy * cb0[9].xyzw + r2.xyzw;
  r2.w = r2.w * r1.x;
