// Artifacts. SSR (very distant) negative colors?
// To investigate later, maybe

// ---- Created with 3Dmigoto v1.3.16 on Thu Aug 22 01:13:56 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  o0.w = cb0[0].x;
		o0.rgb = max(0, o0.rgb);					// seems to fix the issue
  return;
}