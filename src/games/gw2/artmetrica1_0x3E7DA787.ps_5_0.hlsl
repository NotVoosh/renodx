// ---- Created with 3Dmigoto v1.3.16 on Thu Aug 22 01:12:45 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.y = r1.y + -r1.z;
  r1.w = saturate(r2.w + r2.w);
  r2.xyz = -r3.xyz + r2.xyz;
  r2.xyz = r1.www * r2.xyz + r3.xyz;
  r1.y = r1.w * r1.y + r1.z;
  r3.xyzw = cb0[10].xyzw * r1.yyyy;
  r1.x = r3.w * r1.x;
  ...
  r1.x = 0.5 * r1.x;
	...
	r1.x = saturate(r1.x);					// artifacts fix
	
  r1.xyz = r1.yzw * r1.xxx;
  r1.xyz = r1.xyz * r0.xxx;
  r3.xyz = t3.Sample(s3_s, v1.xy).xyz;
  r2.xyz = r3.xyz * r2.xyz;
