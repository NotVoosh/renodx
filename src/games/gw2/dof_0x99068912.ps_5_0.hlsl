...
// ---- Created with 3Dmigoto v1.3.16 on Thu Aug 22 01:13:39 2024
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.y = r0.w * r0.z;
  r1.xzw = float3(0.660000026,0.660000026,0.660000026) * r1.yyy;
  r2.xy = cb0[2].xy * r1.xx * injectedData.fxDof;					// dof
  r2.zw = -r2.yx;
  ...
  r3.x = -cb0[2].x * injectedData.fxDof;							// dof
  r3.yw = float2(0,0);
  r0.zw = r3.xy * r1.zy + r0.xy;
  r4.xyz = t0.Sample(s0_s, r0.zw).xyz;
  r2.xyz = r4.xyz + r2.xyz;
  r3.z = cb0[2].x * injectedData.fxDof;								// dof
  r0.zw = r3.zw * r1.wy + r0.xy;
  r3.xyz = t0.Sample(s0_s, r0.zw).xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r3.y = -cb0[2].y * injectedData.fxDof;							// dof
  r3.xz = float2(0,0);
  r0.zw = r3.xy * r1.yw + r0.xy;
  r4.xyz = t0.Sample(s0_s, r0.zw).xyz;
  r2.xyz = r4.xyz + r2.xyz;
  r3.w = cb0[2].y * injectedData.fxDof;								// dof
