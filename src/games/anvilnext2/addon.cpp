...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    UpgradeRTVReplaceShader(0x94E08EA6),  // LUT
    CustomShaderEntry(0xEA53A0F5),  // FXAA
    // Unity
    CustomShaderEntry(0x25BD08AB),  // bloom
    ...
    // Syndicate
    UpgradeRTVReplaceShader(0xCCAC4BDD),  // tonemap
    CustomShaderEntry(0x1D2B29C6),  // temporal blur
    CustomShaderEntryCallback(0xF25923CB, [](reshade::api::command_list* cmd_list) {  // UI
    shader_injection.hasLoadedTitleMenu = true;
    game = 1;
    return true;
    }),
    // Steep
    UpgradeRTVReplaceShader(0x27344A84),  // tonemap
    UpgradeRTVReplaceShader(0xD8F68A50),  // LUT
    UpgradeRTVReplaceShader(0x52119117),  // videos
    CustomShaderEntryCallback(0xA0505F16, [](reshade::api::command_list* cmd_list) {  // UI
    shader_injection.hasLoadedTitleMenu = true;
    game = 2;
    return true;
    }),
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "colorGradeLUTStrengthB",
        .binding = &shader_injection.colorGradeLUTStrengthB,
        .default_value = 100.f,
        .label = "2nd LUT Strength",
        .section = "Color Grading",
        .tint = 0x01A8DF,
        .max = 100.f,
        .is_enabled = []() { return shader_injection.toneMapType != 1.f; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Color Grading",
        .tooltip = "Controls 1st LUT/2nd LUT respectively.",
        .labels = {"Luminance/Luminance", "Luminance/Per Channel", "Per Channel/Luminance", "Per Channel/Per Channel"},
        .tint = 0x01A8DF,
        .is_enabled = []() { return shader_injection.toneMapType >= 2.f; },
        .is_visible = []() { return current_settings_mode >= 2; },
    },
    ...
    new renodx::utils::settings::Setting{
      ...
      .max = 100.f,
      .parse = [](float value) { return value * 0.01f; },
      .is_visible = []() { return game == 2 && current_settings_mode >= 1; },
  },
  new renodx::utils::settings::Setting{
    .key = "fxLensFlare",
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("colorGradeLUTStrengthB", 100.f);
    ...
    new renodx::utils::settings::Setting{
      ...
      .label = "Anti-Aliasing should be set to MSAA+FXAA or TXAA+FXAA.",
      .section = "Notes",
...
void OnPresetOff() {
  ...
  renodx::utils::settings::UpdateSetting("fxLensDirt", 100.f);
