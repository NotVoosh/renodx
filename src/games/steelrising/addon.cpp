...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x7327C976),  // splashart (opening)
    CustomShaderEntry(0x4C97EF9B),  // videos (opening)
    CustomShaderEntry(0x1B0FD990),  // videos (title)
    CustomShaderEntry(0xA45A7649),  // tonemap
    CustomShaderEntry(0x3A87434B),  // pp
    CustomShaderEntry(0x67426F8D),  // final
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("colorGradeClip", 66.f);
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Steelrising";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      renodx::mods::swapchain::swap_chain_upgrade_targets.push_back({
          ...
          .ignore_size = true,
          .use_resource_view_cloning = true,
          .usage_include = reshade::api::resource_usage::copy_source | reshade::api::resource_usage::copy_dest,
      });
      //  videos
      renodx::mods::swapchain::swap_chain_upgrade_targets.push_back({
