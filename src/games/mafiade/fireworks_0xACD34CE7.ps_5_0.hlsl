...
Texture2D<float4> t0 : register(t0);    // firework texture
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = cb1[0].xyz * r1.xyz; // 1, 1, 1
  r1.xyz = cb1[0].www * r1.xyz; // 3
  r1.xyz = cb0[0].xxx * r1.xyz; // 1
  r1.w = 0;
  ...
  if (r2.y != 0) {
    ...
    r6.y = cb2[26].y;
    r6.w = 1;
    r7.x = dot(cb2[31].xyzw, r6.xyzw);  // -0.1079, -0.63902, 0.76158, -4.82709
    r7.y = dot(cb2[32].xyzw, r6.xyzw);  // 0.99416, -0.06938, 0.08264, -7.95703
    r7.z = dot(cb2[33].xyzw, r6.xyzw);  // 0.00003, 0.76605, 0.64278, 3.72255
    r6.xyz = -cb2[1].xyz + r7.xyz;      // -4.82709, -7.95703, 3.72255
    r6.xyz = cb2[2].www * r6.xyz;       // 0.00033
    r0.x = dot(r6.xyz, r6.xyz);
    r0.x = rsqrt(r0.x);
    r7.xyz = r6.xyz * r0.xxx;
    r0.x = dot(cb3[16].xyz, r7.xyz);    // -0.87274, 0.45943, 0.16507
    r0.y = -cb3[61].x + 1;
    r0.y = r0.y * r0.y;
    ...
    r0.x = r6.z * r0.y + r0.x;
    r8.xyz = cb3[64].xyz * cb3[63].yyy;  // 0.59244, 0.72267, 1.00
    r3.z = max(r2.y, r0.x);
    ...
    //r0.xyw = exp2(r0.xyw);
      r0.rga = sign(r9.rgb) * pow(abs(r9.rgb), r0.x);
