...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x87158C20),  // videos
    CustomShaderEntry(0x31B52561),  // LutBuilderHdr
    CustomShaderEntry(0x3087C1DD),  // uberpost
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for HUNTER×HUNTER NEN×IMPACT";
...
BOOL APIENTRY DllMain(HMODULE h_module, DWORD fdw_reason, LPVOID lpv_reserved) {
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      renodx::utils::random::binds.push_back(&shader_injection.random1);
      renodx::utils::random::binds.push_back(&shader_injection.random2);
      renodx::utils::random::binds.push_back(&shader_injection.random3);
